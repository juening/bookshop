...
export const createBookReview = (bookId, review) => async (dispatch, getState) => {
    try {
        ...
        setTimeout(() => {
            dispatch({
                type:BOOK_CREATE_REVIEW_REMOVE_ALERT
            })
        }, 5000)
    }
}
